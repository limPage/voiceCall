...
//    private String selectedEncoder = "static_whisper_base_ko_10s_encoder_ver05.rknn";
//    private String selectedDecoder = "static_whisper_base_ko_10s_decoder_ver05.rknn";
...
//
//        try {
//            File execFile = new File(execDir, "static_rknn_whisper_demo_10s");
//            if (!execFile.exists()) {
//                try (InputStream is = getAssets().open("static_rknn_whisper_demo_10s");
